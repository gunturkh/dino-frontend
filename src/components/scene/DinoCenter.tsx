...
const DinoCenter = ({ scene }: any) => {
  ...
  const EggIcon1 = PIXI.Assets.get("EggIcon1").orig;
  const EggIcon2 = PIXI.Assets.get("EggIcon2").orig;
  const EggIcon3 = PIXI.Assets.get("EggIcon3").orig;
  const BtnPagePaginationActive = PIXI.Assets.get("BtnPagePaginationActive").orig;
  const BtnPagePaginationNumberInactive = PIXI.Assets.get("BtnPagePaginationNumberInactive").orig;
