...
const ProfileTemp = ({
  ...
  const obscureEmail = (email: string) => {
    ...
    return `${name[0]}${new Array(4).join("*")}${name[name.length - 1]}@${domain}`;
  };
  ...
  const menuItem = [
    ...
    },
    {
      ...
      >
        <Sprite
          texture={PIXI.Assets.get(toggleWithdrawal ? 'SwitchOnIcon' : 'SwitchOffIcon')}
          anchor={[0.5, 0.5]}
      ...
      {isLoaded && <Container>
        ...
        <Container position={[app.screen.width / 2, 0]}>
          ...
          >
            ...
            {/* Avatar Container */}
            <Container
              position={[0, isNotMobile ? 160 : 135]}
            >
              <Sprite
              ...
              {/* nickname */}
              <Container
                position={[0, ProfileBgBounds.height / 2 + (isNotMobile ? 40 : 25)]}
              >
                <Text
                  text='test1234'
                  position={[0, 0]}
              ...
              <Text
                text={`ID:${'12345678'}`}
                position={[0, ProfileBgBounds.height / 2 + (isNotMobile ? 70 : 50)]}
                anchor={[0.5, 0.5]}
                style={new PIXI.TextStyle({
                  fontFamily: 'Magra Regular',
